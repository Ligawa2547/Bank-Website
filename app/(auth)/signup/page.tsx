    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0A3D62] to-[#1e5f8b] p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-[#0A3D62]">Create Account</CardTitle>
          <CardDescription>Join I&E Bank and start your financial journey</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="text-[#0A3D62] hover:underline font-medium">
                Sign in here
              </Link>
            </p>
          </div>
