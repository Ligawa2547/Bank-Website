...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        // Fetch user profile from users table (including account_no)
        ...
        // Fetch recent transactions using account_no
        const { data: transactionsData, error: transactionsError } = await supabase
          .from("transactions")
          .select("*")
          .eq("account_no", userData.account_no)
        ...
        // Fetch savings accounts using account_no
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 bg-blue-50 p-2 rounded-md">
          ...
          <div>
            <p className="text-sm font-medium">Account #{profile?.account_no}</p>
